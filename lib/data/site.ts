  ...
  mitra: [
    {
      ...
      deskripsi: {
        id: "Yayasan AMAL adalah organisasi pendamping masyarakat adat Dayak yang berbasis di Desa Antang, Kalimantan Tengah. Selama lebih dari satu dekade, AMAL mendampingi kelompok-kelompok masyarakat dalam memperjuangkan izin perhutanan sosial, mengembangkan produk HHBK, dan membangun kelembagaan ekonomi masyarakat. AMAL adalah mitra strategis yang memfasilitasi lahirnya Koperasi Bulau Ngandung.",
        en: "Yayasan AMAL is a supporting organization for Dayak indigenous communities based in Antang Village, Central Kalimantan. For over a decade, AMAL has assisted community groups in fighting for social forestry permits, developing NTFP products, and building community economic institutions. AMAL is the strategic partner that facilitated the birth of the Bulau Ngandung Cooperative.",
        zh: "Yayasan AMAL是一个支持达雅克土著社区的组织，总部位于中加里曼丹的Antang村。十多年来，AMAL协助社区团体争取社会林业许可证、开发HHBK产品并建设社区经济机构。AMAL是促进Bulau Ngandung合作社诞生的战略伙伴。",
        ja: "AMAL財団は中部カリマンタンのアンタン村を拠点とするダヤック先住コミュニティの支援組織です。10年以上にわたり、AMALはコミュニティグループが社会林業許可証を獲得し、非木材林産物を開発し、コミュニティ経済機関を構築するのを支援してきました。AMALはブラウ・ガンドゥン協同組合の誕生を促進した戦略的パートナーです。",
      },
    },
  ],
  kontakEmail: "info@bulawngandung.org",
